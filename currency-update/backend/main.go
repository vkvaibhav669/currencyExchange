...
// 	log.Println("Failed to parse API response txt error  :", err.Error())
// }
// fmt.Println(apr)
// fmt.Printf("\n %T \n", apiResults)
// fmt.Printf("\n %T \n", apr)
